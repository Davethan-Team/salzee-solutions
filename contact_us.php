...
if (isset($_POST['is_ajax']) && $_POST['is_ajax'] == '1') {
    ...
    try {
        ...
        $body = "
            ...
            <body>
                <div class='container'>
                    <h2>New Salzee Solutions Ltd Website Inquiry</h2>
        ...
        // Replace this mock with your actual PHPMailer/SMTP code configured on Hostinger.
        ...
        if ($email_sent_successfully) {
            ...
            // Actual failure message from PHPMailer or SMTP error would go here
            $response['message'] = 'We encountered an error while sending your message. Please try again or contact us directly at info@salzeeglobal.com.';
        }
        ...
        <div class="max-w-7xl mx-auto container-padding">
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-12">
                    ...
                    <h2 class="font-heading text-3xl font-bold text-brand-charcoal border-b pb-3 border-gray-100">
                        Get In Touch
                    </h2>
                    ...
                    <form id="contact-form" class="space-y-5">
                        ...
                        <div>
                            <button type="submit" id="submit-button"
                                class="w-full inline-flex items-center justify-center px-6 py-3 bg-brand-teal text-white font-bold rounded-lg hover:bg-brand-teal-dark transition duration-150 shadow-xl font-heading transform hover:scale-[1.005]">
                                Send Message
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function showOverlay(success, message) {
            ...
            formWrapper.innerHTML = `
                ...
                <button onclick="hideOverlay()" class="mt-4 px-4 py-2 ${buttonClass} font-semibold rounded-lg transition">Close</button>
            `;
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    showOverlay(true, result.message);
                    form.reset(); // Clear the form on success
                } else {
                    showOverlay(false, result.message);
                }

            } catch (error) {
                console.error('Submission failed:', error);
                showOverlay(false, 'A critical network error occurred. Please check your connection or try again later.');
            } finally {
                // Reset button state
